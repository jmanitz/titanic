...
::: {.column width="60%"}
![](/class_titanic_files/images/ml_workflow.PNG) [^1]
:::
:::::
...
::: {.column width="50%"}
![](/class_titanic_files/images/ml_eval.PNG)
:::
:::::
...
::: {.column width="50%"}
![](/class_titanic_files/images/bagging.PNG) [^2]
:::
:::::
...
::: {.column width="50%"}
<!-- ![](/class_titanic_files/images/book.PNG) -->
